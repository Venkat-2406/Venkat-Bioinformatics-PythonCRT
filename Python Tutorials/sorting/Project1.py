'''Design a backend system to manage multiplayer game tournaments.
Players register play matches, earn points.
System should rank them, handle tiebreakers and simulate knockout rounds
1)Player Registration with Unique names
2)Match results entry and automatic point updates
3)Leaderboard sorted by score
4)Simulate knockout using recursion
5)Export Match History
Tech Stack:
Core Python- lists,dictionaries,tuples
OOP-Player, Match, Tournament ,Classes
Recursion- Knockount, Simulation
Sorting Algorithms- Leaderboard
File Handling- History Logs
Pandas for final score export
'''
import random

class Player:
    def __init__(self, username):  # Fixed constructor
        self.username = username
        self.score = 0

class Match:
    def __init__(self, player1, player2, winner):  # Fixed constructor
...
t.register_player("Diana")
t.add_match_result("Alice", "Bob", "Alice")
t.add_match_result("Charlie", "Diana", "Charlie")
print("\n🏅 Leaderboard:")
